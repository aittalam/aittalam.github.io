...
In my previous post I made a comparison between AI-assisted Web search and coding, and I am convinced there's a strong parallel between them (as well as with any other technology that gets augmented by these new models). One thing they have in common is the [slot-machine](https://pluralistic.net/2025/08/16/jackpot/) effect: it's very easy to remember the jackpots and overseeing the failures. But the evidence of local models getting better and more useful for different tasks is recently growing (check out e.g. Antirez' [search experiment](https://x.com/antirez/status/2066233392916525379) with his ds4-agent and Vicki Boykis' excellent blog post [Running local models is good now](https://vickiboykis.com/2026/06/15/running-local-models-is-good-now/)). Trying to keep myself honest, I have used this search agent for a couple of months before starting to write anything and collected the examples you saw along the way. Here are my conclusions regarding the pros, the cons, and the open questions of this setup.
